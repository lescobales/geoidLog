...
struct qt_meta_stringdata_Graphique_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Graphique_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Graphique_t qt_meta_stringdata_Graphique = {
    {
QT_MOC_LITERAL(0, 0, 9) // "Graphique"
...
const QMetaObject Graphique::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Graphique.data,
      qt_meta_data_Graphique,  qt_static_metacall, nullptr, nullptr}
};
...
void *Graphique::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Graphique.stringdata0))
